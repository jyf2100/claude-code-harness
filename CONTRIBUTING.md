...
1. Check if the issue already exists in [GitHub Issues](https://github.com/jyf2100/claude-code-harness/issues)
...
| Deprecated | 宣布即将删除的功能时 |
| Removed | 删除功能或命令时 |
| Fixed | 修复错误或缺陷时 |
| Security | 进行安全相关的修复时 |

**Before/After 表格**：仅在体验发生重大变化（命令废弃/合并、工作流更改、破坏性变更）时添加。轻微修正可省略。
