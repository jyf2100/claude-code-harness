...
| スキル | トリガーキーワード | 除外 |
|--------|-----------------|------|
| `harness-plan` | create a plan, add tasks, update Plans.md, mark complete, check progress, sync status, where am I, /harness-plan, /sync-status | implementation, code review, release |
| `harness-work` | implement, execute, /harness-work, /work, do everything, build features, run tasks, breezing, team run, --codex, --parallel | planning, code review, release, setup |
