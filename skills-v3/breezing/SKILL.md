...
> **Claude Code vs Codex の通信 API**:
> - Claude Code: `SendMessage(to: agent_id, message: "...")` で Worker に修正指示
> - Codex: `send_input(agent_id, "...")` で同等の操作
>
> harness-work / team-composition.md では Claude Code の `SendMessage` 構文で記述。
> Codex 環境では `send_input` に読み替えること。
