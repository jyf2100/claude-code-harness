---
name: merge-plans
description: "Plans.md 合并更新技能（保留用户任务）。需要在多个 Plans.md 之间进行整合时使用。"
allowed-tools: ["Read", "Write", "Edit"]
---

# Merge Plans Skill

更新现有 Plans.md 时，保留用户任务数据的同时
应用模板结构的技能。
...
<!-- cc:TODO, pm:依頼中（兼容: cursor:依頼中） 的任务记载在这里 -->
...
<!-- cc:完了, pm:確認済（兼容: cursor:確認済） 的任务记载在这里 -->
