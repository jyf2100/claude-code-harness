...
**完了報告に「Commit Status: Pending PM Approval」が含まれている場合**:
...
前回のタスクは承認済みです。**保留中の変更をコミットしてから**、次のタスクを実装してください。
...
**通常の approve の場合（Commit Pending なし）**:
